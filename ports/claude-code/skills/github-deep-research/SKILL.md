...
<!-- deerflow-origin: ported from skills/public/github-deep-research/ @ 0950924
     port: tools: web_search/web_fetch -> WebSearch/WebFetch, read_file -> Read; script path.
-->

# GitHub Deep Research Skill

Multi-round research combining GitHub API, WebSearch, WebFetch to produce comprehensive markdown reports.
...
**Round 1 - GitHub API**
Directly execute `scripts/github_api.py` without `Read()`:
```bash
python ${CLAUDE_PLUGIN_ROOT}/skills/github-deep-research/scripts/github_api.py <owner> <repo> summary
python ${CLAUDE_PLUGIN_ROOT}/skills/github-deep-research/scripts/github_api.py <owner> <repo> readme
python ${CLAUDE_PLUGIN_ROOT}/skills/github-deep-research/scripts/github_api.py <owner> <repo> tree
```
...
**Round 3 - Deep Investigation (5-10 WebSearch + WebFetch)**
- Technical architecture details
- Timeline of key events
- Community sentiment
- Use WebFetch on valuable URLs for full content
