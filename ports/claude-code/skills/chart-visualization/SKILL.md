...
<!-- deerflow-origin: ported from skills/public/chart-visualization/ @ 0950924
     dropped-frontmatter (preserved here, not understood by Claude Code): compatibility: {nodejs: ">=18.0.0"}
     port: script invocation uses ${CLAUDE_PLUGIN_ROOT}.
-->
...
**Execution Command:**
```bash
node ${CLAUDE_PLUGIN_ROOT}/skills/chart-visualization/scripts/generate.js '<payload_json>'
```
