...
<!-- deerflow-origin: ported from skills/public/academic-paper-review/ @ 0950924
     port: tools: web_fetch -> WebFetch; present_files -> final-message file listing; outputs path.
-->
...
Use `WebFetch` on key related papers or surveys to understand where this work fits.
...
- Save the review to `outputs/review-{paper-topic}.md` when working in sandbox
- Present the review to the user by listing its path in your final message
