...
<!-- deerflow-origin: ported from skills/public/deep-research/ @ 0950924
     port: tools: web_fetch/web_search -> WebFetch/WebSearch.
-->
...
# Use temporal qualifiers — always use the ACTUAL current year from today's date
...
**Always check today's date in your context before forming ANY search query.**

Your context gives you the full current date: year, month, day, and weekday (e.g. `2026-02-28, Saturday`). Use the right level of precision depending on what the user is asking:
