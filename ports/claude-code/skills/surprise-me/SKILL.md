...
<!-- deerflow-origin: ported from skills/public/surprise-me/ @ 0950924
     port: no substitution needed; cross-referenced skills are discovered at runtime.
-->
...
Read all the skills available to you (Claude Code keeps every available skill's name and description in your context).
