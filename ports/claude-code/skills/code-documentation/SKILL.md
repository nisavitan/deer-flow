...
<!-- deerflow-origin: ported from skills/public/code-documentation/ @ 0950924
     port: tools: read_file -> Read, present_files -> final-message listing; upload/output paths.
-->
...
Use the file tools (Read, Grep, Glob, Bash) to explore the codebase:
...
# Read key files
Read ./project-dir/package.json
Read ./project-dir/pyproject.toml

# Search for public API surfaces
grep -r "export " ./project-dir/src/
grep -r "def " ./project-dir/src/ --include="*.py"
grep -r "func " ./project-dir/ --include="*.go"
```
...
- Present generated files to the user by listing their paths in your final message
