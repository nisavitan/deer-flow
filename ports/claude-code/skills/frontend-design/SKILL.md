...
<!-- deerflow-origin: ported from skills/public/frontend-design/ @ 0950924
     dropped-frontmatter (preserved here, not understood by Claude Code): license: Complete terms in LICENSE.txt
     port: frontmatter only; LICENSE.txt shipped alongside.
-->
