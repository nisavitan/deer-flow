...
<!-- deerflow-origin: ported from skills/public/newsletter-generation/ @ 0950924
     port: tools: web_fetch -> WebFetch, present_files -> final-message listing; outputs path.
-->
...
For key stories, use `WebFetch` to read full articles and extract:
...
- Present the newsletter to the user by listing its path in your final message
