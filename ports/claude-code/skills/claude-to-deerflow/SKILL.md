...
<!-- deerflow-origin: ported from skills/public/claude-to-deerflow/ @ 0950924
     port: script invocation path only; talks to a user-run DeerFlow instance over HTTP.
-->
...
```bash
bash ${CLAUDE_PLUGIN_ROOT}/skills/claude-to-deerflow/scripts/chat.sh "Your question here"
```
