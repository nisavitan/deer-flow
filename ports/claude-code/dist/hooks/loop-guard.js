 ...
 */
export function evaluateLoopGuard(payload, options) {
    ...
    const stepped = result;
    if (stepped === null || stepped.decision === 'none' || stepped.message === null)
        return null;
