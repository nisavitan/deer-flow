...
const SILENT = { threadId: null, filePath: null, scanned: 0, truncated: false };
/**
 ...
 */
export function captureTurnSnapshot(payload, options) {
    ...
    try {
        ...
        process.stderr.write(`deerflow turn-snapshot: standing down (${error instanceof Error ? error.message : String(error)})\n`);
